<template>
    <footer class="lg:flex items-center justify-between text-center bg-gray-300 px-12 py-6">
        ...
        <p>
            <a class="text-gray-600 hover:text-gray-800" target="_blank" href="https://github.com/ExpDev07/legacy-rp-admin-v3">
                <span class="fab fa-github text-gray-800 text-lg mr-1"></span>
                Github
            </a>
        </p>
    </footer>
