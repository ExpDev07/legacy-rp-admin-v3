        ...
        <form class="w-full" @submit.prevent>
            <div class="flex flex-wrap mb-4">
                ...
                <div class="w-1/3 px-3">
                    ...
                    <input class="block w-full border rounded bg-gray-200 py-3 px-4 mb-3" id="identifier" placeholder="steam:11000010df22c8b" v-model="query.identifier">
                </div>
                <!-- Action -->
                <div class="w-1/3 px-3">
                    ...
                    <input class="block w-full border rounded bg-gray-200 py-3 px-4 mb-3" id="action" placeholder="Death" v-model="query.action">
                </div>
                <!-- Server -->
                <div class="w-1/3 px-3">
                    ...
                    <input class="block w-full border rounded bg-gray-200 py-3 px-4 mb-3" id="server" placeholder="3" type="number" v-model="query.server">
                </div>
            </div>
            <!-- Details -->
            <div class="w-full px-3">
                ...
                <input class="block w-full border rounded bg-gray-200 py-3 px-4 mb-3" id="details" placeholder="Marius killed jax with an AK-47" v-model="query.details">
            </div>
        </form>
    </div>
